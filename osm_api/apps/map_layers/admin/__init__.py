"""
Dynamic admin registration for all 46 concrete layer models.

Unlike the other apps, this stays a single module: every layer table has
the same shape, so one loop builds a GISModelAdmin per model instead of
46 near-identical hand-written files.
"""
